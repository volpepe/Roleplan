...
$(document).ready(function(){
    $("#quest-button").click(function(){
        window.location = "addcompletedquest.php?WORLD=<?php echo $_GET["WORLD"];?>&AREA=<?php echo $_GET["AREA"];?>"
    })
    $("#assign-button").click(function(){
        window.location = "assignquest.php?WORLD=<?php echo $_GET["WORLD"];?>&AREA=<?php echo $_GET["AREA"];?>"
    })
})
</script>