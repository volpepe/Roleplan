...
$(document).ready(function(){
    $("#pg-button").click(function(){
        window.location = "../operations/viewpg.php?WORLD=<?php echo $_GET["WORLD"];?>";
    })
    $("#work-button").click(function(){
        window.location = "../operations/findjobs.php?WORLD=<?php echo $_GET["WORLD"];?>";
    })
    $("#ingredient-button").click(function(){
        window.location = "../operations/findingredients.php?WORLD=<?php echo $_GET["WORLD"];?>";
    })
})
</script>