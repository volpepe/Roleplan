...
<head>
    ...
    <title>RolePlan: Game Quest Page</title>
</head>
...
$(document).ready(function(){
    $("#quest-button").click(function(){
        window.location = "../operations/addcompletedquest.php?WORLD=<?php echo $_GET["WORLD"];?>&AREA=<?php echo $_GET["AREA"];?>"
    })
    $("#assign-button").click(function(){
        window.location = "../operations/assignquest.php?WORLD=<?php echo $_GET["WORLD"];?>&AREA=<?php echo $_GET["AREA"];?>"
    })
})
</script>