...
<head>
    ...
    <title>RolePlan: Quest Assigning Page</title>
</head>
<body>
    <div class="container-fluid">
        ...
        <form>
            <div class="container">
                ...
                <div class="form-group">
                    <label for="quest">Quest da assegnare: </label>
                    <select name="quest" id="quest" class="custom-select">
                    <?php
                        $sql = "SELECT Arco, NumQuest, Nome FROM quest";
                        $result = mysqli_query($conn, $sql);
                        while ($row = mysqli_fetch_assoc($result))
                        {
                            echo "<option arco=" . $row["Arco"] . " numquest=" . $row["NumQuest"] . ">" . $row["Nome"] . "</option>";
                        }
                    ?>
                    </select>
                </div>
