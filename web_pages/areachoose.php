...
if (!isset($_GET["callback"])){
    echo "Questa pagina va chiamata dalla pagina di selezione del mondo";
}
else {
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>RolePlan: Area Selection</title>
</head>
<body>
    <div class="container-fluid">
        ...
        <form>
            <div class="container">
                <h3>Scegli l'area su cui operare</h3>
            <?php
                ...
                {
            ?>
                <input type="button" class="btn btn-primary dec worldchoose" id=<?php echo $row["IDArea"];?> value='<?php echo $row["NomeArea"];?>'/>
            <?php
                }
            ?>
            </div>
